...
Public Class SupplierReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.SupplierReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupplierReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SupplierReport1 = New SupplierReport1
        rpt.Site = Me.Site
        Return rpt
    End Function
