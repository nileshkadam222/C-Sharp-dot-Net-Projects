...
Partial Public Class DataSet3
    ...
    Partial Public Class BillInfoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddBillInfoRow(ByVal Bid As String, ByVal _Date As String, ByVal Name As String, ByVal Pid As String, ByVal Prdname As String, ByVal Qty As String, ByVal Rate As String, ByVal Amt As String) As BillInfoRow
            Dim rowBillInfoRow As BillInfoRow = CType(Me.NewRow,BillInfoRow)
            Dim columnValuesArray() As Object = New Object() {Bid, _Date, Name, Pid, Prdname, Qty, Rate, Amt}
    ...
    Partial Public Class BillInfoRow
        ...
        Public Property Bid() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Bid' in table 'BillInfo' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsBidNull() As Boolean
            Return Me.IsNull(Me.tableBillInfo.BidColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetBidNull()
            Me(Me.tableBillInfo.BidColumn) = Global.System.Convert.DBNull
        End Sub
