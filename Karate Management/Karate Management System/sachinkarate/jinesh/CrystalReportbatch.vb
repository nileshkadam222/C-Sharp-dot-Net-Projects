...
Public Class CrystalReportbatch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CrystalReportbatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportbatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportbatch = New CrystalReportbatch
        rpt.Site = Me.Site
        Return rpt
    End Function
