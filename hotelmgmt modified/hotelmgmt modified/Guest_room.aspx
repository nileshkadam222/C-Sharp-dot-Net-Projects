<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Guest_room.aspx.cs" Inherits="Guest_room" %>
...
<h5 style="width: 884px; height: 29px; margin-left: 91px; margin-right: 76px;">
    <asp:LinkButton ID="LinkButton10" runat="server" PostBackUrl="~/Home.aspx">Back to Home</asp:LinkButton>
</h5>
</asp:Content>
