...
Public Class rptIPBillReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HospitalManagementSystem.rptIPBillReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIPBillReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIPBillReport = New rptIPBillReport
        rpt.Site = Me.Site
        Return rpt
    End Function
