...
Public Class rptDischargeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HospitalManagementSystem.rptDischargeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDischargeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDischargeReport = New rptDischargeReport
        rpt.Site = Me.Site
        Return rpt
    End Function
