...
namespace SangliTradingCompany
{
    public partial class UpdateDryFruit : Form
    {
        ...
        private void UpdateDryFruit_Load(object sender, EventArgs e)
        {
            prodIDcombo2.Text = "";
            pronamecomb2.Text = "";
            con.Open();
        ...
        private void Update_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Update  DryFruitTable set SerialNumber='" + serno_txt.Text + "',ProductID='" + proid_txt.Text + "',ProductName='" + Proname_cmbo.Text + "',Quantity='" + quan_txt.Text + "',Box='" + Box_txt.Text + "',Weight='" + weight_txt.Text + "',Price='" + price_txt.Text + "',OrderDate='" + dateTimePicker1.Value + "',ExpiredDate='" + dateTimePicker2.Value + "' Where (ProductName='" + Proname_cmbo.Text + "') ", con);
