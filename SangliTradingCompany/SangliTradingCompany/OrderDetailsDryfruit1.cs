...
{
    public partial class OrderDetailsDryfruit1 : Form
    {
        String c = Properties.Settings.Default.Database1ConnectionString;
        SqlConnection con;
        public OrderDetailsDryfruit1()
        {
        ...
        {
            con.Open();
            string cmd = "insert into DryFruitOrderDetails_Table values('" + proid_combo.Text + "','" + proname_combo.Text + "', '" + quantity_txt.Text + "','" + boxes_txt.Text + "','" + weight_txt.Text + "','" + unitprice_txt.Text + "','" + suppid_combo.Text + "','" + suppname_combo.Text + "','" + dateTimePicker1.Value + "','" + total_txt.Text + "' )";
