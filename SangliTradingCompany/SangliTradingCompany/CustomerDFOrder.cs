...
{
    public partial class CustomerDFOrder : Form
    {

        String c = Properties.Settings.Default.Database1ConnectionString;
        SqlConnection con;
        public CustomerDFOrder()
        {
        ...
        private void CustomerDFOrder_Load(object sender, EventArgs e)
        {
            con.Open();
        ...
        private void save_btn_Click(object sender, EventArgs e)
        {
            ...
            string cmd = "insert into CustomerInvoice_Table1 values('" + Custname_combo.Text + "','" + compname_combo.Text + "', '" + Convert.ToInt32( proid_combo.Text) + "','" + proname_combo.Text + "','" + quantity_txt.Text + "','" + Boxes_txt.Text + "','" + weight_txt.Text + "','" + unitprice_txt.Text+ "','" + totalamount_txt.Text + "','" + payment_det + "','" + chequeno_txt.Text + "', '" + dateTimePicker1.Value + "','" + paidamount_txt.Text + "','" + Balance_txt.Text + "')";
