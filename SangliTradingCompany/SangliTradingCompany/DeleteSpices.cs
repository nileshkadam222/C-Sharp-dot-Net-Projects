...
{
    public partial class DeleteSpices : Form
    {
        ...
        private void DeleteSpices_Load(object sender, EventArgs e)
        {
            prodIDcombo2.Text = "";
            pronamecomb2.Text = "";
            con.Open();
        ...
        private void Delete_btn_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "delete from SpicesTable where ProductName='" + Proname_cmbo.Text + "'";
            try
            {
