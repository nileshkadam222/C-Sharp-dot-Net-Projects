...
Public Class Search_addmission
    ...
    'Dim i As Integer
    Private Sub Search_addmission_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmb_search_by_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_search_by.SelectedIndexChanged
        If cmb_search_by.Text = "Student_Name" Then
            ...
            lblstud_id.Visible = False
            con.Open()
            str = "select stud_lname from addmission"
        ...
        If cmb_search_by.Text = "Student_Id" Then
            ...
            lblstud_name.Visible = False
            con.Open()
            str = "select stud_id from addmission"
            cmd = New SqlCommand(str, con)
            dr = cmd.ExecuteReader
            cmb_stud_id.Items.Clear()
            Do While dr.Read
    ...
    Private Sub btnsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        ...
        If i = 0 Then
            con.Open()
            da = New SqlDataAdapter("select * from addmission where stud_lname='" & cmb_stud_name.Text & "' ", con)
            da.Fill(dt)
            dgvstud.DataSource = dt
            con.Close()
        ElseIf i = 1 Then
            con.Open()
            da = New SqlDataAdapter("select * from addmission where stud_id=" & cmb_stud_id.Text & " ", con)
            da.Fill(dt)
            dgvstud.DataSource = dt
            con.Close()
        End If
    ...
    Private Sub btnreset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreset.Click
        str1 = "select * from addmission order by stud_id asc"
        Try
            con.Open()
            da = New SqlDataAdapter(str1, con)
            ds = New DataSet
