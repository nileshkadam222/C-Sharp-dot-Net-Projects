...
Public Class Search_Student
    ...
    Private Sub cmb_search_by_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_search_by.SelectedIndexChanged
        If cmb_search_by.Text = "Student_Name" Then
            ...
            con.Open()
            str = "select stud_lname from Resgistration_details"
        ...
        If cmb_search_by.Text = "Student_Id" Then
            ...
            con.Open()
            str = "select stud_id from Resgistration_details"
            cmd = New SqlCommand(str, con)
            dr = cmd.ExecuteReader
            cmb_stud_id.Items.Clear()
            Do While dr.Read
    ...
    Private Sub btnsearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsearch.Click
        ...
        If i = 0 Then
            con.Open()
            da = New SqlDataAdapter("select * from Resgistration_details where stud_lname='" & cmb_stud_name.Text & "' ", con)
            da.Fill(dt)
            dgvstud.DataSource = dt
            con.Close()
        ElseIf i = 1 Then
            con.Open()
            da = New SqlDataAdapter("select * from Resgistration_details where stud_id=" & cmb_stud_id.Text & " ", con)
            da.Fill(dt)
            dgvstud.DataSource = dt
            con.Close()
        End If
    ...
    Private Sub btnreset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreset.Click
        str1 = "select * from Resgistration_details order by stud_id asc"
        Try
            con.Open()
    ...
    Private Sub Search_Student_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmb_stud_id.Visible = False
        cmb_stud_name.Visible = False
        lblstud_id.Visible = False
        lblstud_name.Visible = False
        ...
        str1 = "select * from Resgistration_details"
        Try
            con.Open()
            da = New SqlDataAdapter(str1, con)
            da.Fill(ds)
