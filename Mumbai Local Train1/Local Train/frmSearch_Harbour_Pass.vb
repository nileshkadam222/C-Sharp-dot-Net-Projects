Public Class frmSearch_Harbour_Pass
    Private Sub frmsearchpassHup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
          Call Connection()
        MsgBox("WELCOME TO HARBOUR LINE")

        cbstation.Visible = False
        optbyticketnumber.Checked = True
        dgharbour.Columns.Add("passno", "PassNo")
        ...
        dgharbour.Columns.Add("passtype", "PassType")
        dgharbour.Columns.Add("months", "Months")
        dgharbour.Columns.Add("class", "Class")
        dgharbour.Columns.Add("expirydate", "ExpiryDate")
        dgharbour.Columns.Add("totalprice", "Total Price")
        dgharbour.Columns.Add("site_pass", "Site_Pass")
    End Sub
