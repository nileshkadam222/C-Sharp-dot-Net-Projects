Public Class frmSearch_Central_Ticket
    Private Sub frmsearchcentralup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Connection()
        MsgBox("WELCOME TO CENTRAL RAILWAY (UP)")

        cbstation.Visible = False
        cbstations.Visible = False
        optbyticketnumber.Checked = True
        dgcentral.Columns.Add("ticketno", "TicketNo")
        ...
        dgcentral.Columns.Add("adult", "Adult")
        dgcentral.Columns.Add("child", "Child")
        dgcentral.Columns.Add("class", "Class")
        dgcentral.Columns.Add("return", "Return")
        dgcentral.Columns.Add("adultprice", "Adult Price")
        dgcentral.Columns.Add("childprice", "Child Price")
        dgcentral.Columns.Add("totalprice", "Total Price")
        dgcentral.Columns.Add("site_ticket", "Site_Ticket")
    End Sub
    ...
    Private Sub lblback_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblback.Click
        Me.Hide()
    End Sub
    Private Sub cbstations_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbstations.Click
