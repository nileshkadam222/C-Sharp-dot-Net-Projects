Public Class frmSearch_Western_Ticket
    Private Sub frmsearchwesternup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
         Call Connection()
        MsgBox("WELCOME TO WESTERN RAILWAY")

        cbstation.Visible = False
        optbyticketnumber.Checked = True
        dgwestern.Columns.Add("ticketno", "TicketNo")
       ...
       dgwestern.Columns.Add("distance", "Distance")
        ...
        dgwestern.Columns.Add("adult", "Adult")
        dgwestern.Columns.Add("child", "Child")
        dgwestern.Columns.Add("class", "Class")
        dgwestern.Columns.Add("return", "Return")
        dgwestern.Columns.Add("adultprice", "Adult Price")
        dgwestern.Columns.Add("childprice", "Child Price")
        dgwestern.Columns.Add("totalprice", "Total Price")
        dgwestern.Columns.Add("site_ticket", "Site_Ticket")
    End Sub
