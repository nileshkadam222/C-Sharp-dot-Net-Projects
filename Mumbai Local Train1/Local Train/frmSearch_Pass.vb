Public Class frmSearch_Pass

    Private Sub frmSearch_Pass_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Connection()

        cbstation.Visible = False
        optbypassnumber.Checked = True
        dgPass.Columns.Add("passno", "PassNo")
        dgPass.Columns.Add("source", "Source")
        dgPass.Columns.Add("destination", "Destination")
        dgPass.Columns.Add("date", "Date")
        dgPass.Columns.Add("time", "Time")
        dgPass.Columns.Add("distance", "Distance")
        dgPass.Columns.Add("duration", "Duration")
        dgPass.Columns.Add("passtype", "PassType")
        dgPass.Columns.Add("months", "Months")
        dgPass.Columns.Add("class", "Class")
        dgPass.Columns.Add("expirydate", "ExpiryDate")
        dgPass.Columns.Add("totalprice", "Total Price")
        dgPass.Columns.Add("site_pass", "Site_Pass")
    ...
    End Sub
    Private Sub optbypassnumber_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles optbypassnumber.Click
        If optbypassnumber.Checked = True Then
            cbstation.Visible = False
        ...
        Select Case cbSites.Text
            Case "WESTERN"
                If optbypassnumber.Checked = True Then
                    ...
                    End If
                    For i = 0 To ctr
                        If txtpassno.Text = ds.Tables("Pass").Rows(i).Item(0) Then
                            dgPass.Rows.Add(ds.Tables(0).Rows(i).Item(0), _
    ...
    Private Sub cmdshowall_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdshowall.Click
        ...
        Select Case cbSites.Text
            ...
            Case "HARBOUR"
                For i = 0 To ctr
                    If ds.Tables(0).Rows(i).Item(12) = "HARBOUR" Then
                        dgPass.Rows.Add(ds.Tables(0).Rows(i).Item(0), _
                               ds.Tables(0).Rows(i).Item(1), _
                               ds.Tables(0).Rows(i).Item(2), _
                               ds.Tables(0).Rows(i).Item(3), _
