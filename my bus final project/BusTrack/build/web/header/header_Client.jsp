...
<div class="body1">
  <div class="main">
    <header>
        <%
        String name_sess=(String)session.getAttribute("user_Name");
      ...
      <div class="wrapper">
        ...
        <div class="right">
         ...
         <nav>
            <ul id="menu">
              <li id="menu_active"><a href="My_agent.jsp">My Account</a></li>
              <li><a href="SearchBus_agent.jsp">Search Bus</a></li>
               <li><a href="Cancel_servation.jsp">Cancel Reservation</a></li>
