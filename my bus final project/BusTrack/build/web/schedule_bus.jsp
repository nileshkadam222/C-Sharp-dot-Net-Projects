...
<%
     String error=(String)session.getAttribute("add_sch");
     int value=Admin_Ser.counter_sch;
...
<div class="main">
  ...
  <!--LEFT HAND SIDE ENDS-->
    ...
    <article class="colA pad_left1">
         <h5><a href="loc_map.jsp">Location Mapping</a></h5>
    <center>
          <h2> Please Schedule Bus Timing</h2><br>
        <%
         if(error!=null){
             if(value==1){
      %>
      ...
      <%
        ...
        %>
             ...
             <form name="frmName" action="AdminSer?do=scheduleBus" method="post" onsubmit="return CheckForm();">
            <table>
                ...
                <tr><td>&nbsp;</td></tr>
               <!-- <tr>
                    <td><Strong>Select the Days of week</Strong>&nbsp;</td>
                    <td>
                          <input type="checkbox" name="week"  id="days" value="Sunday">Sunday
                        <input type="checkbox" name="week" id="days" value="Monday">Monday
<input type="checkbox" name="week" id="days" value="Tuesday" >Tuesday
<input type="checkbox" name="week" id="days" value="Wendsday" >Wendsday
<input type="checkbox" name="week" id="days" value="Thusday" >Thusday
<input type="checkbox" name="week" id="days" value="Friday" >Friday
<input type="checkbox" name="week" id="days" value="Saturday" >Saturday
                    </td>
                </tr>-->
               <tr>
 ...
 <tr><td>&nbsp;</td></tr>
 <tr><td><strong>Leaving Time from Source</strong>&nbsp;</td>
   ...
   <tr><td>&nbsp;</td></tr>
   <tr><td><strong>Destination Time</strong>&nbsp;</td>
...
<script>
    function  CheckForm(){
      ...
      var time=document.frmName.time.value;
      var datepicker=document.frmName.datepic.value;
       var hour_to=document.frmName.Hr_to.value;
      var min_to=document.frmName.Min_to.value;;
    ...
    function ResetValues(){
      ...
      document.frmName.time.value="-1";
       document.frmName.Hr_to.value="-1";
      document.frmName.Min_to.value="-1";
       document.frmName.datepic.value="";
