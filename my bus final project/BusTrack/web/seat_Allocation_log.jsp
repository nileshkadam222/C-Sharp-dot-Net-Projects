...
<html>
    ...
    <%
                   ...
                   String bus_no=(String)session.getAttribute("bus_sign");
                   String dest=(String)session.getAttribute("dest_sign");
                   session.setAttribute("pay_bus_no_log",bus_no);
    ...
    <body>
        ...
        <div>
            <center>
                ...
                <%while(rs.next()){
                 session.setAttribute("seatprice_log",String.valueOf(rs.getFloat(5)));
                    ...
                    <td width="450">
                       <center>
                         ...
                         sql="select seatno,tag from bus_reserv where travel_dt='"+travel_dt+"'";
                          ...
                          rs=ps.executeQuery();
                         %>
                         <form name="frmName" method="post" action="payment_log.jsp" onsubmit="return checkEmpty();">
                        <table  width="450">
                            <tr><td>
                             <% while(rs.next()){
