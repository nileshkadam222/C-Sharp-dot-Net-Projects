...
<%
     String error=(String)session.getAttribute("ADD_USER");
     int value=Admin_Ser.new_user;
  ...
  <!--LEFT HAND SIDE ENDS-->
    ...
    <article class="colA pad_left1">
      ...
      <%
        ...
        <form name="frmName" action="AdminSer?do=insert_user" method="post" onsubmit="return CheckForm();">
            <table>
