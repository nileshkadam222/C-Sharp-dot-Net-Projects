Public Class Main
    ...
    Private Sub ChangeBookingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ShowForm(fEditBooking, Me)
    End Sub

    Private Sub ChangeCheckInToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ShowForm(fEditCheckIn, Me)
    End Sub
